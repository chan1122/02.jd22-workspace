...
public class JAVA07 {
    // public JAVA07(){} -> 만들지 않아도 같은 이름의 메서드 -> 생성자가 만들어 짐!
    /***********************************************
     * 클래스명과 동일한 이름의 파일에는
    ...
    public static void main(String[] args) {
        ...
        // 1 . 클래스 생성
        // 과일 클래스 생성 및 클래스 호출,속성 변경하기!
        Fruits fruits = new Fruits("고기", "라면", "ㅋ", 30);   
...
class Fruits {
    ...
    // 5 . 과일에 대한 정의는 : 값을 못바꾸도록 상수화 함!! final
    final String definition = "나무따위를 가꾸어 얻는, 사람이 먹을수 있는열매";
    ...
    public Fruits(String 사과, String 빨강초록, String 사과향, double weight) {
        // 속성값 셋팅!
        this.name = 사과;
        this.color = 빨강초록;
        this.flavor = 사과향;
        ...
        // 생성자에서는 내가 처음에 실행코자 하는
        // 코드를 넣으면 된다!!!^^
    } ////// Fruits 생성자 //////

    //메서드 2 -> 과일의 정의를 찍는 메서드
    ...
    public void fruitsFn(){
        System.out.println("나는"+name+"입니다. 색은"+color+"이고 냄새는"+flavor+"입니다. 개당무게는"+weight+"kg입니다");
    }
